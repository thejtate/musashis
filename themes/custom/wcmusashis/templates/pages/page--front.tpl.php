...
<header class="header _dropdown-top_nav">
  ...
  </nav></header>	<div class="inner-wrapper-top">
        ...
        <div class="share-wrapp">
          <ul class="list-share">
            <?php if (isset($share_facebook) && !empty($share_facebook)): ?>
              <li class="item-facebook"><?php print l(t('facebook'), $share_facebook, array('attributes' => array('target' => "_blank")));?></li>
            <?php endif; ?>
            <?php if (isset($share_twitter) && !empty($share_twitter)): ?>
              <li class="item-twitter"><?php print l(t('twitter'), $share_twitter, array('attributes' => array('target' => "_blank")));?></li>
            <?php endif; ?>
            <?php if (isset($share_yelp) && !empty($share_yelp)): ?>
              <li class="item-mail"><?php print l(t('yelp'), $share_yelp, array('attributes' => array('target' => "_blank")));?></li>
            <?php endif; ?>
          </ul>
        </div>
      </div>
