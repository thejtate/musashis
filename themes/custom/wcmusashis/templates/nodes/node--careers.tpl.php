...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php
    $url = (isset($content['field_careers_link']['#items'][0]['url'])) ? $content['field_careers_link']['#items'][0]['url'] : "";
  ?>
  ...
  <div class="content-item clearfix">
    <div class="pull-right content-right">
      <div class="frame-inner">
        ...
        <figure class="image">
          <?php print render($content['field_careers_image']); ?>
        </figure>
      </div>
    </div>
    <div class="b-text">
      <?php print render($content['field_careers_description']); ?>
      <?php if (!empty($url)): ?>
      <div class="btn-wrapp">
        <?php print l(t("APPLY ONLINE"), $url, array("attributes" => array("class" => array("btn"))))?>
      </div>
      <?php endif; ?>
    </div>
  </div>
